...
6. 真实账单导入已完成并验收（2026-08-14 复核通过，见 `reports/23_*`）；当前剩余 **344 条**待确认（未匹配 247、人际转账 44、退款 46、其他中性 2、提现 5）。退款严格等额且不限时间窗口；亲情卡/生活费/余利宝规则已执行（备份 `ledger.sqlite-20260828-210310.bak`）。处理完成前，正式统计以 `/inbox` 处理进度为准，不宣称"账已对平/已正式发布"。
